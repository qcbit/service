...
func validateShutdown(err error) bool {
	...
	// data is being written or streams to the client.
	// https://blog.cloudfare.com/the-complete-guide-to-golang-net-http-timeouts/
	...
	case errors.Is(err, syscall.EPIPE):
		...
		// closed connection causes the peer to reply with an RST package indicating that the
	...
	case errors.Is(err, syscall.ECONNRESET):
		...
		// packet instead of hte TCP FIN, which is used to close a connection under normal
		// circumstances.
		return false
	}
	return true
