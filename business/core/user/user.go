...
// Update replaces a user record in the database.
...
// Query retrieves a list of existing users form the database.
...
// QueryByEmail gets the specified use from the database by email.
